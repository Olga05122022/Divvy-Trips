...
all_trips_v2$day_of_week <- ordered(all_trips_v2$day_of_week, levels=c("воскресенье", "понедельник", "вторник", "среда", "четверг", "пятница", "суббота"))
...
write.csv(counts, file = "clean data.csv")
